...
export default function Login() {
    ...
    const renderSelectionMode = () => (
        <div className="space-y-3">
            {/* Phone & Email Temporarily Disabled
            <Button
                variant="outline"
        ...
        <div className="min-h-[85vh] flex items-center justify-center py-16 px-5 relative isolate">
            ...
            <div className="w-full max-w-sm">
                <div className="text-center mb-10">
                    <img src="/logo.png" alt="Rentora" className="w-16 h-16 rounded-2xl mx-auto mb-5 shadow-sm transform -rotate-3 hover:rotate-0 transition-transform object-cover" />
